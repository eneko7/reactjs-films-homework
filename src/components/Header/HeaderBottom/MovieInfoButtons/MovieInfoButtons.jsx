    ...
    return (
      <div className={style.bottom_right}>
        ...
        <div className={`${active} ${style.bottom_right_buttons_box}`}>
          <button
            className={`${style.bottom_right_buttons_box_button_watch} ${style.bottom_right_buttons_box_button}`}
            type="button"
          >
            Watch Now
          </button>
          <button
            className={`${style.bottom_right_buttons_box_button_view} ${style.bottom_right_buttons_box_button}`}
            onClick={this.openInfoClick}
            type="button"
          >
            {!isOpen ? 'View Info' : 'Close'}
          </button>
        </div>
      </div>
    );
